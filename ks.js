...
*/
const ksjsbCookie='kuaishou.api_st=Cg9rdWFpc2hvdS5hcGkuc3QSoAEaWEOaHT2lhXJM91l1HEOCP7tGuW1IENQ56W18l3CBjRfqbiJh1vuSntkGAXWhIo7mbtw_am8HZZB6riAovlFabCvhMlAMk-PruQDxqkA4oZpg57nSHAGdRgTg-GUfU04BSUhdwMziwyMwAPniSfAVKWnPc58XsBeDIVY-vCfEzpUyI0zG7B3VRlahMJ5JFHN-tyH_W3C5YFC4z11IdkGyGhJvFHrrKslACKKghHE7NlCD-YgiIPKBRvywrtFwpdrUCu_VY6lSGx43iHT3y0ss8vzPjO1EKAUwAQ;'
...
class _0x9d8dda {
    ...
    async [IM(0x4f0)](T, c) {
        ...
        let C = {
            'url': p['yBkCl'],
            'body': p[VS(0x715)](p[VS(0x7bd)](p['lQmXY'](VS(0x2cc) + T, p[VS(0x3fe)]) + JSON[p[VS(0x373)]](p['pKMlS'](p[VS(0x715)](p['IAUkG'], c), '\"}')) + p[VS(0x302)], +new Date()), p[VS(0x5ed)]),
            'headers': {
                'User-Agent': p[VS(0x20b)],
                'Cookie': p[VS(0x8fa)](p['lQmXY'](p['grloF'] + Math[p[VS(0x69a)]](p[VS(0x935)](p[VS(0x471)](Math[p[VS(0x580)]](), 0x3e8), 0x1)) + ' ANDROID_ff60a387f6ba8904; ', this['cookie']), p[VS(0xa3a)]),
